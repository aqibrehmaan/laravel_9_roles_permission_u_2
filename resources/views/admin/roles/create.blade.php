        ...
        <div class="mx-auto mt-12 max-w-md rounded bg-gray-100 p-6">
            <form action="{{ route('admin.roles.store') }}" class="space-y-5" method="POST">
              ...
              <div>
                ...
                <input id="name" type="text" name="name" class="mt-2 block w-full appearance-none rounded-md border-2 border-gray-100 py-3 px-3 text-gray-800 focus:border-gray-200 focus:text-gray-500 focus:outline-none" />
